...
from pathfinding_agent2 import pathfinding_direction
...
class Agent:
    ...
    def defend_flag(self, agent_pos_row, agent_pos_col, flag, pathfinding_world, all_enemys):
        direction = pathfinding_direction((agent_pos_row, agent_pos_col), (flag[0], flag[1]+DEFEND_POSITION), pathfinding_world, all_enemys)
        action = "move"
        return action, direction
    ...
    def search(self, agent_pos_row, agent_pos_col, pathfinding_world, all_enemys):
        ...
        elif not self.up_corner_visited:
            action = "move"
            direction = pathfinding_direction((agent_pos_row, agent_pos_col), UP_CORNER, pathfinding_world, all_enemys)
        elif self.search_location != None:
            print("Seaching locatiom", self.search_location)
            action = "move"
            direction = pathfinding_direction((agent_pos_row, agent_pos_col), self.search_location, pathfinding_world, all_enemys)
            if (agent_pos_row, agent_pos_col) == self.search_location:
    ...
    def avoid(self, agemt_pos_row, agent_pos_col, current_vision):
        pass
